        ...
        <div id="video-body">
            ...
            <div id="video-right-right">
                <div id="right-navigation">
                    <img id="player-back" src="../../images/sys/back.png" @click="lastVideo">
                    <img id="player-next" src="../../images/sys/next.png" @click="nextVideo">
                </div>        
            </div>
        </div>
...
export default{
    ...
    methods:{
        ...
        async handleFindVideoByPage(){
            const response = await findVideoByPage(this.pageSize, this.currentPage);
            ...
            for (let i = 0; i < response.data.data.total - this.pageSize * (response.data.data.currentPage - 1) && i < this.pageSize; i++) {
                try {
                    ...
                    `${import.meta.env.VITE_BASE_API}/live/.m3u8`
                    const videosrc = `${import.meta.env.VITE_BASE_VIDEO}/hls/${videoid}/intermediate/index.m3u8`;
